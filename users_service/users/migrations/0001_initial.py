...
import users_service.users.managers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('user', 'Usuário Comum'), ('seller', 'Vendedor'), ('admin', 'Administrador')], default='user', max_length=20, verbose_name='Tipo de Usuário')),
            ...
            managers=[
                ('objects', users_service.users.managers.UserManager()),
            ],
        ),
    ]
